    ...
    <div>
        ...
        <div class='hot-area'>
            ...
            <div class='hot-goods'>
                <van-list>
                    <van-row>
                        <van-col class='goods-item' span='12' v-for='(item, index) in hotGoods' :key='index'>
                            <div class='goods-image'>
                                <img v-lazy='item.image' style='display: block;' width='100%' />
                            </div>
...
<script>
    ...
    import { getShoopingMall } from 'api/shoppingMall'
    export default {
        data() {
            return {
        ...
        mounted () {
            this._getShoopingMall()
        },
        methods: {
            _getShoopingMall () {
                getShoopingMall().then((res) => {
